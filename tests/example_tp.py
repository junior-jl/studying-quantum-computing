...
from .local/lib/python3.8/site-packages/netsquid/examples/teleportation import (example_network_setup, example_sim_setup)
from netsquid/examples/teleportation import (example_network_setup, example_sim_setup)
from netsquid.examples.teleportation import (example_network_setup, example_sim_setup)
